...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_creatematrix.clicked.connect(self.call_api_creatematrix)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "playfair_matrix" in data and isinstance(data["playfair_matrix"], list):
                    ...
                    self.ui.matrix.setText(matrix_string)
    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200 :
                data = response.json()
                self.ui.CipherText.setText(data["encrypted_text"])
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200 :
                data = response.json()
                self.ui.PlainText.setText(data["decrypted_text"])
